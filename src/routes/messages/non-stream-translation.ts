// Anthropic <-> OpenAI payload translation (extracted from cpn8n, Copilot-decoupled)
...
import { mapOpenAIStopReasonToAnthropic } from "~/lib/utils"
...
export function translateToOpenAI(
  ...
  const thinkingBudget = payload.thinking?.budget_tokens
  return {
    model: payload.model,
